...
router.get('/github/:username', async (req, res) => {
  ...
  try {
    const options = {
      uri: `https://api.github.com/users/${uname}/repos?per_page=10&sort=created:asc&client_id=${config.get('githubClientId')}&client_secret=${config.get('githubClientSecret')}`,
      method: 'GET',
